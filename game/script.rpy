...
define e = Character('Эйлин', color="#000000")
define my = Character('[myname]', color="#000000") # При объявлении ГГ  вместо имени пишется переменная с именем в квадратных скобках
...
label strtgame:
    "\"ГеймстудияВперед\" – небольшая, но развивающаяся компания, которая движется вперед и разрабатывает супер игры, не обделяя свои проекты инновационными механиками и нестандартными решениями."
    "Обычно, подобное свойственно больше для инди-разработчиков. Все же, уникальные и новые вещи всегда сопровождаются большими рисками."
    ...
    "Первые проекты аудитория встретила с большим успехом. Последние несколько – мягко говоря не очень."
    "Студия еще держится, а в разработке находится новый продукт. У него действительно есть перспективы на рынке, поэтому лучше бы ему быть успешным."
    "Потому что я – главный геймдизайнер(продуктменеджер хз кто ты) у этой игры. И если провалится он, меня вероятнее всего сократят ^^;."
